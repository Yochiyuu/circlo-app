document.addEventListener("DOMContentLoaded", () => {
  ...
  const allStoriesData = [
    ...
    },
    {
      user: "@bradpitt",
      profilePic:
        "https://hips.hearstapps.com/hmg-prod/images/actor-brad-pitt-attends-the-photocall-of-the-movie-wolfs-news-photo-1726680022.jpg?crop=0.670xw:1.00xh;0.0760xw,0&resize=640:*",
      storyContent:
        "https://www.mnctrijaya.com/uploads/news/d717b62f-7e2e-469f-a662-2cb5e30b1371.jpg",
      type: "image",
    },
    {
      user: "@jvke",
      profilePic:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsID3K344ZfK_PJDnIB4f-GLP3mfD00_tIgw&s",
      storyContent:
        "http://i.scdn.co/image/ab67616d0000b273a0934c15232680a3afc9da6e",
      type: "image",
    },
  ];
    ...
    wrapper.innerHTML = `
            <div class="story-content">
                ...
                <div class="story-media">
                    ${
                      story.type === "video"
                        ? `<video src="${story.storyContent}" muted loop autoplay playsinline></video>`
                        : `<img src="${story.storyContent}" alt="Story" />`
                    }
