...
let chatHistory = {
  ...
  "Marco_Jago.Gitar": [
    ...
    {
      id: 2,
      text: "Boleh deh co, kan lu jago banget main gitarnya",
      sender: "self",
    },
  ],
  "Carlos.Suka.Bobo": [
    {
      id: 1,
      text: "Los, lu dimana? lu inget kan ada kelas hari ini?",
      sender: "self",
    },
  ...
  Putra_Cyber: [
    {
      id: 1,
      text: "Put, tolong bantuin gua bikin firewall dong buat topologi gua",
      sender: "other",
    },
    {
      id: 2,
      text: "Ooo lu gak bisa ya? yaudah sini gua bikinin",
      sender: "self",
    }, // Pesan ini bisa kamu coba edit/hapus
  ],
};
  ...
  contact.addEventListener("click", () => {
    ...
    chatHeader.innerHTML = `
            <div class="user-info">
                ...
                }" alt="${name}" style="width: 32px; height: 32px; border-radius: 50%; margin-right: 10px;">
...
function deleteMessage(id) {
  if (!currentContact) return;
  const indexToDelete = chatHistory[currentContact].findIndex(
    (msg) => msg.id === id
  );
  if (indexToDelete > -1) {
